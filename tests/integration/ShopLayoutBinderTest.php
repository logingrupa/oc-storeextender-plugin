...
/**
 * Layout double for this test. FakeBinderLayout already exists at global scope
 * in ThemeUserBinderTest.php and always answers a session component, while this
 * binder registers three aliases, so the double here is named apart and returns
 * one component object per alias.
 */
